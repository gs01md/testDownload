 ...
 *  任务代理
 */
@protocol protocol_baseTask <NSObject>
...
@interface VGBaseTask : NSObject<Protocol_VGNetworkStatus>
 ...
 *  任务代理
 */
@property(nonatomic , strong) id<protocol_baseTask> m_protocol_baseTask;
