 ...
 *  任务代理
 */
@protocol protocol_uploadTask <NSObject>
...
@interface VGTaskUpload : NSObject<Protocol_VGNetworkStatus>
 ...
 *  任务代理
 */
@property(nonatomic , strong) id<protocol_uploadTask> m_protocol_baseTask;
